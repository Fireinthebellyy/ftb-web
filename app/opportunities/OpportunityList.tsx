...
export default function OpportunityCardsPage() {
	...
	return (
		<div className="h-full grow bg-gray-50">
			...
			<FeedbackWidget />
			<div className="fixed right-6 bottom-[72px] z-50 flex size-10 items-center justify-center rounded-full bg-neutral-200 text-neutral-600 shadow-lg transition hover:bg-neutral-100 md:bottom-6 md:size-12">
				<Link
