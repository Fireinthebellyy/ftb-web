    ...
    <footer className="pb-safe fixed right-0 bottom-0 left-0 z-[60] border-t border-slate-100 bg-white px-4 py-3 shadow-[0_-8px_30px_rgb(0,0,0,0.04)]">
      ...
      <div className="flex items-center gap-2 w-full">
        {hasApply && (
          ...
          >
            <Button className="h-11 w-full rounded-xl border-none bg-[#ec5b13] hover:bg-[#d44d0c] font-bold text-white shadow-none transition-all active:scale-95 text-[11px] px-1 flex items-center justify-center gap-1">
        ...
        {hasDM && (
          ...
          >
            <Button className="h-11 w-full rounded-xl border-none bg-[#0077b5] hover:bg-[#005987] font-bold text-white shadow-none transition-all active:scale-95 text-[11px] px-1 flex items-center justify-center gap-1">
              <Image
        ...
        {hasMail && (
          ...
          >
            <Button className="h-11 w-full rounded-xl border-none bg-black hover:bg-zinc-800 font-bold text-white shadow-none transition-all active:scale-95 text-[11px] px-1 flex items-center justify-center gap-1">
