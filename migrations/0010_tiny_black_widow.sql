...
ALTER TABLE "users_sync" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
DROP TABLE "users_sync" CASCADE;--> statement-breakpoint
...
ALTER TABLE "opportunities" ADD CONSTRAINT "opportunities_created_by_user_users_sync_id_fk" FOREIGN KEY ("created_by_user") REFERENCES "neon_auth"."users_sync"("id") ON DELETE no action ON UPDATE no action;