...
import { sprintSessionContents } from "@/lib/schema";
...
export async function PUT(
  ...
  try {
    ...
    const updateData: Partial<typeof sprintSessionContents.$inferInsert> & { updatedAt: Date } = {
      updatedAt: new Date(),
    };
    ...
    activityError = error;
    console.error("Error updating sprint session content:", error);
    activityStatus = 500;
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    activityError = error;
    console.error("Error deleting sprint session content:", error);
    activityStatus = 500;
    return NextResponse.json(
    ...
    void logAdminActivity({
      request,
      action: "admin.sprints.sessions.content.delete",
      statusCode: activityStatus,
      success: activityStatus >= 200 && activityStatus < 300,
      adminUserId: activityAdminUserId,
      entityType: "sprint_session_content",
