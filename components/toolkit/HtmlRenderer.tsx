  ...
  const htmlContent = (
    <div
      ...
      className={cn(
        ...
        "[&_blockquote]:border-l-4 [&_blockquote]:border-orange-500 [&_blockquote]:bg-orange-50 [&_blockquote]:px-4 [&_blockquote]:py-2 [&_blockquote]:italic [&_blockquote]:text-gray-700",
