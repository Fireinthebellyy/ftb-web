...
import { FileText, MessageCircle, MessageSquare, Video, CheckCircle } from "lucide-react";
          ...
          <div className="space-y-1">
            {chatUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-gray-700 transition-all hover:bg-gray-100"
              >
