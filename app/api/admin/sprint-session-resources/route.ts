...
export async function POST(request: Request) {
  ...
  try {
    ...
    activityError = error;
    console.error("Error creating sprint resource:", error);
    activityStatus = 500;
