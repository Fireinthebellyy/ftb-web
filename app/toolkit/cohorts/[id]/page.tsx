        ...
        <Drawer.Portal>
          ...
          <Drawer.Content className="bg-white flex flex-col rounded-t-[20px] h-[85vh] fixed bottom-0 left-0 right-0 z-50 max-w-lg mx-auto overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
              {/* Buddy Offer Card */}
              <div className="relative group overflow-hidden p-[2px] rounded-xl bg-gradient-to-r from-orange-300 via-[#ff5e14] to-yellow-400 animate-gradient hover:shadow-[0_0_20px_rgba(255,94,20,0.3)] transition-all duration-300">
                <div className="relative bg-white/95 backdrop-blur-sm p-4 rounded-[10px] space-y-3 z-10 h-full">
                  <div className="flex items-center justify-between">
                    <label className="text-xs font-black text-[#ff5e14] uppercase tracking-wider flex items-center gap-2">
                      <Gift className="w-5 h-5 animate-pulse" /> Buddy Offer!
                    </label>
                    <span className="bg-orange-100 text-[#ff5e14] text-[9px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                      Optional Referral
                    </span>
                  </div>
                  <p className="text-xs text-gray-600 font-medium">
                    Learning is better together! Enter your friend's email below so they can get access too.
                  </p>
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2.5 border-2 border-orange-100 focus:border-[#ff5e14] focus:ring-4 focus:ring-orange-500/20 rounded-lg text-sm transition-all bg-white outline-none"
                    />
                    <Gift className="w-4 h-4 text-orange-300 absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none group-focus-within:text-[#ff5e14] transition-colors" />
                  </div>
                </div>
              </div>
